...
- **JavaScript**: Para la interacción dinámica y funcionalidad del sitio.
- **Framework CSS personalizado**: Un sistema de estilos reutilizables para mantener consistencia y escalabilidad.
