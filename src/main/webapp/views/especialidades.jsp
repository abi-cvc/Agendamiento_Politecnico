    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="<%= request.getContextPath() %>/resenas.jsp" class="font-bold">Mis Reseñas</a></li>
        ...
        <div class="especialidades-container">
            ...
            <aside class="especialidades-menu">
                ...
                <nav class="menu-especialidades">
                    <c:forEach var="esp" items="${especialidades}" varStatus="status">
                        <a href="#${esp.nombre}" class="menu-item ${status.first ? 'active' : ''}">
            ...
            <!-- Contenido de especialidades DINÁMICO -->
            <section class="especialidades-content">
                <c:forEach var="especialidad" items="${especialidades}">
                    <article id="${especialidad.nombre}" class="especialidad-card">
                        <div class="especialidad-header">
                            <div class="especialidad-icon">${especialidad.icono}</div>
                            <div>
                                <h2>${especialidad.titulo}</h2>
                                <p class="especialidad-subtitle">Atención profesional de calidad</p>
                            </div>
                        </div>
                        <div class="especialidad-body">
                            ...
                            <h3>Servicios</h3>
                            <ul>
                                <c:forTokens items="${especialidad.servicios}" delims="|" var="servicio">
                                    <li>${servicio}</li>
                                </c:forTokens>
                            </ul>
                            <div class="mt-4">
        ...
        <div class="footer-main">
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<%= request.getContextPath() %>/resenas.jsp">Mis Reseñas</a></li>
                </ul>
            </div>
